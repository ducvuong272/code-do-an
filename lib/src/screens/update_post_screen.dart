...
//đổ api lấy thông tin post theo user vào
  @override
  void initState() {
    ...
    print(widget.post.district);
    print(widget.post.postCategory);
    print(widget.post.city);
    print(widget.post.country);
    print(widget.post.userId);
    print(widget.post.postTitle);
    print(widget.post.phoneNumber);
    print(widget.post.openTime);
    print(widget.post.closeTime);
    print(widget.post.lowestPrice);
    print(widget.post.highestPrice);
    print(widget.post.postDetail);
